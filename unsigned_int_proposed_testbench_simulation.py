...
simulations = [
    ("Test_Bench_proposed/Unsigned_int/tb_unsigned_int_L0.v", "test_Unsigned_int_L0"),
    ("Test_Bench_proposed/Unsigned_int/tb_unsigned_int_L1.v", "test_Unsigned_int_L1"),
    ("Test_Bench_proposed/Unsigned_int/tb_unsigned_int_L2.v", "test_Unsigned_int_L2"),
]
...
def run_iverilog_sim(testbench, output_name):
    ...
    try:
        ...
        csv_dir = "Simulation_Results/proposed/Unsigned_int"
...
def main():
    if not os.path.exists("Simulation_Results/proposed/Unsigned_int"):
        os.makedirs("Simulation_Results/proposed/Unsigned_int")
