...
simulations = [
    ("Test_Bench/Signed_int/tb_signed_int_L0.v", "test_Signed_int_L0"),
    ("Test_Bench/Signed_int/tb_signed_int_L1.v", "test_Signed_int_L1"),
    ("Test_Bench/Signed_int/tb_signed_int_L2.v", "test_Signed_int_L2"),
]
...
def run_iverilog_sim(testbench, output_name):
    ...
    try:
        ...
        compile_cmd = [
            "iverilog", "-g2012", 
            "-o", output_name, 
            "RTL/signed_int_mul.v", # Add your specific RTL files or use "RTL/*.v"
        ...
        csv_dir = "Simulation_Results/base/Signed_int"
...
def main():
    ...
    if not os.path.exists("Simulation_Results/base/Signed_int"):
        os.makedirs("Simulation_Results/base/Signed_int")
