...
simulations = [
    ("Test_Bench_proposed/Signed_int/tb_signed_int_L0.v", "test_Signed_int_L0"),
    ("Test_Bench_proposed/Signed_int/tb_signed_int_L1.v", "test_Signed_int_L1"),
    ("Test_Bench_proposed/Signed_int/tb_signed_int_L2.v", "test_Signed_int_L2"),
]
...
def run_iverilog_sim(testbench, output_name):
    ...
    try:
        ...
        compile_cmd = [
            "iverilog", "-g2012", 
            "-o", output_name, 
            "RTL_proposed/signed_int_mul.v", # Add your specific RTL files or use "RTL/*.v"
...
def main():
    ...
    if not os.path.exists("Simulation_Results/proposed/Signed_int"):
        os.makedirs("Simulation_Results/proposed/Signed_int")
