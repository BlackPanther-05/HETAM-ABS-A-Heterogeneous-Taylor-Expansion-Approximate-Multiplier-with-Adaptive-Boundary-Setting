...
simulations = [
    ("Test_Bench/Fixed_point/tb_fixed_point_L0.v", "test_Fixed_point_L0"),
    ("Test_Bench/Fixed_point/tb_fixed_point_L1.v", "test_Fixed_point_L1"),
    ("Test_Bench/Fixed_point/tb_fixed_point_L2.v", "test_Fixed_point_L2"),
]
...
def run_iverilog_sim(testbench, output_name):
    ...
    try:
        ...
        compile_cmd = [
            "iverilog", "-g2012", 
            "-o", output_name, 
            "RTL/fixed_point_mul.v", # Add your specific RTL files or use "RTL/*.v"
        ...
        csv_dir = "Simulation_Results/Fixed_point"
...
def main():
    ...
    if not os.path.exists("Simulation_Results/Fixed_point"):
        os.makedirs("Simulation_Results/Fixed_point")
