...
simulations = [
    ("Test_Bench_proposed/Floating_point/tb4float_L0.v", "test_float_point_L0"),
    ("Test_Bench_proposed/Floating_point/tb4float_L1.v", "test_float_point_L1"),
    ("Test_Bench_proposed/Floating_point/tb4float_L2.v", "test_float_point_L2"),
]
...
def run_iverilog_sim(testbench, output_name):
    ...
    try:
        ...
        compile_cmd = [
            "iverilog", "-g2012", 
            "-o", output_name, 
            "RTL_proposed/floating_point_mul.v", # Add your specific RTL files or use "RTL/*.v"
