...
//
//   Output paths (relative to Test_Bench/approx_t/ — the vvp cwd):
...
module tb_approx_t;
    ...
    initial begin : sim_main
        ...
        if (width_arg == 8) begin
            case (level)
                0: $dumpfile("../../vcd/approx_t/approx_t_w8_level0.vcd");
                1: $dumpfile("../../vcd/approx_t/approx_t_w8_level1.vcd");
                2: $dumpfile("../../vcd/approx_t/approx_t_w8_level2.vcd");
                3: $dumpfile("../../vcd/approx_t/approx_t_w8_level3.vcd");
                4: $dumpfile("../../vcd/approx_t/approx_t_w8_level4.vcd");
                5: $dumpfile("../../vcd/approx_t/approx_t_w8_level5.vcd");
            endcase
        end else begin
            case (level)
                0: $dumpfile("../../vcd/approx_t/approx_t_w24_level0.vcd");
                1: $dumpfile("../../vcd/approx_t/approx_t_w24_level1.vcd");
                2: $dumpfile("../../vcd/approx_t/approx_t_w24_level2.vcd");
                3: $dumpfile("../../vcd/approx_t/approx_t_w24_level3.vcd");
                4: $dumpfile("../../vcd/approx_t/approx_t_w24_level4.vcd");
                5: $dumpfile("../../vcd/approx_t/approx_t_w24_level5.vcd");
            endcase
        end
        ...
        $display(" CSV  -> Simulation_Results/approx_t/results_w%0d_level%0d.csv",
                  width_arg, level);
        $display(" VCD  -> vcd/approx_t/approx_t_w%0d_level%0d.vcd (flushed)",
                  width_arg, level);
        $display("============================================================");
        $finish;
