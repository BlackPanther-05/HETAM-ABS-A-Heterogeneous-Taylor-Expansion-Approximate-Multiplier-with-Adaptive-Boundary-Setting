...
module floating_point_multiplier_tb;
    ...
    initial begin
        file_ptr = $fopen("Floating_point.csv", "w");
        ...
        for (i = 32'b0; (i < 32'hffffffff) || (i == 32'hffffffff); i = i + 1'b1) begin
            // Generating valid IEEE 754 floating-point number for input "a"
            a = i;
            
            for (j = 32'b0; (j < 32'hffffffff) || (j == 32'hffffffff); j = j + 1'b1) begin
            // Generating valid IEEE 754 floating-point number for input "b"
            b = j;
            ...
            $display("| %d |  %f  |   %f  |    %f    |   %f   |  %f  |  %f  |",
                     test_counter, real_a, real_b, real_result, real_result_re, real_result - real_result_re, (real_result_re / real_result));
